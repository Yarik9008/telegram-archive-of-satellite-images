...
def main():
    while True:
        ...
        passList = open("C:/Lorett/telegram-archive-of-satellite-images/pass_list.txt", 'r').readlines()
...
if __name__ == "__main__":
    ...
    with open("C:/Lorett/telegram-archive-of-satellite-images/config_arch_bot.json", 'r') as file_config:
